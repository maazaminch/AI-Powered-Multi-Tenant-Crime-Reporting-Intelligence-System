...
const StationCasesPage = () => {
  ...
  const { cases, pagination, isLoading, error, refetch } = useStationCases({
    page,
    ...filters
  })
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Command Center - Overview of all cases in your station
          </CardDescription>
        </CardHeader>
      </Card>
...
export default StationCasesPage
