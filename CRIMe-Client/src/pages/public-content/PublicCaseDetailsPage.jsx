    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <ErrorState 
          ...
          description="Case ID and tracking token are required"
        />
      </div>
    )
  }
              ...
              <Card className="border border-slate-400">
                ...
                <CardContent className="pt-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="font-medium text-lg">Station Address</p>
                      <p className="text-sm text-muted-foreground">{caseDetails.policeStationId?.address}</p>
                    </div>
                    <div>
                      <p className="font-medium text-lg">Email</p>
                      <p className="text-sm text-muted-foreground">{caseDetails.policeStationId?.email}</p>
                    </div>
                    <div>
