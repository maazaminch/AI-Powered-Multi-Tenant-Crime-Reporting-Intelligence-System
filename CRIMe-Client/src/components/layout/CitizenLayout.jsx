...
const CitizenLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/citizen/cases', label: 'Cases' },
        ...
        <div className="container mx-auto px-6 py-4 ml-0">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex-1 text-center">
              <h1 className="text-2xl font-bold text-white">Citizen Panel</h1>
            </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-96 bg-white" align="end">
                  ...
                  <DropdownMenuItem asChild className='cursor-pointer border border-slate-300 hover:bg-gray-900' >
                    <Link to="/citizen/notifications">View all notifications</Link>
                  </DropdownMenuItem>
                </DropdownMenuContent>
                </DropdownMenuPortal>
              </DropdownMenu>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-40 bg-white" align="start">
                  <DropdownMenuGroup>
                    ...
                    <DropdownMenuItem asChild className='cursor-pointer hover:bg-gray-500' >
                      <Link to="/citizen/change-password">Change Password</Link>
                    </DropdownMenuItem>
                  </DropdownMenuGroup>
                  <DropdownMenuSeparator />
                  <DropdownMenuGroup>
